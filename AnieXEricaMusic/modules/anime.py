...
from AnieXEricaMusic.anime.data_parser import (
    get_all_genres,
    get_all_tags,
    get_studio_animes,
    get_studios,
...
from AnieXEricaMusic.anime.helper import (
    clog,
    check_user,
    get_btns,
    rand_key,
...
from AnieXEricaMusic.anime.db import get_collection
...
𝖾𝗑𝖺𝗆𝗉𝗅𝖾: /𝖺𝗇𝗂𝗆𝖾 𝖲𝗐𝗈𝗋𝖽 𝖠𝗋𝗍 𝖮𝗇𝗅𝗂𝗇𝖾"""
    ...
    try:
        ...
        await clog('AnieXEricaMusic', title_img, 'LINK', msg=message)
        await client.send_photo(
...
𝖾𝗑𝖺𝗆𝗉𝗅𝖾: /𝗆𝖺𝗇𝗀𝖺 𝖲𝗐𝗈𝗋𝖽 𝖠𝗋𝗍 𝖮𝗇𝗅𝗂𝗇𝖾"""
    ...
    try:
        ...
        await clog('AnieXEricaMusic', pic, 'LINK', msg=message)
        await client.send_photo(
            gid, failed_pic, caption=finals_, reply_markup=buttons
        )
...
async def character_cmd(client: Client, message: Message, mdata: dict):
    ...
    try:
        ...
        await clog('AnieXEricaMusic', img, 'LINK', msg=message)
        await client.send_photo(
...
𝖾𝗑𝖺𝗆𝗉𝗅𝖾: /𝖺𝗂𝗋𝗂𝗇𝗀 𝖲𝗐𝗈𝗋𝖽 𝖠𝗋𝗍 𝖮𝗇𝗅𝗂𝗇𝖾""")
    ...
    try:
        ...
        await clog('AnieXEricaMusic', coverImg, 'LINK', msg=message)
...
This material is marked 18+ and not allowed in this group"""
    ...
    try:
        ...
        await clog('AnieXEricaMusic', pic, 'LINK', msg=cq)
        await cq.edit_message_media(
