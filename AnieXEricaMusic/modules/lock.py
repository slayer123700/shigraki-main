...
from AnieXEricaMusic.database.lockdb import (
    set_lock,
    unset_lock,
    get_locks,
)
from AnieXEricaMusic.database.approve_db import is_user_approved
from AnieXEricaMusic.helper.user import is_user_admin
from AnieXEricaMusic import ptb , LOCK_GROUP
from AnieXEricaMusic.helper.handler import MultiCommandHandler
from AnieXEricaMusic.helper.lock_helper import LOCK_CHAT_RESTRICTION, LOCKABLES, UNLOCK_CHAT_RESTRICTION
