...
from AnieXEricaMusic.vars import FLIRT as FLIRT_STRINGS , TOSS as TOSS_STRINGS , EYES , MOUTHS , EARS , DECIDE as DECIDE_STRINGS , weebyfont , normiefont 
...
@app.on_message(filters.regex(r"^(?i)AnieXEricaMusic Ek Joke Sunao$"))
@error
@save
...
@app.on_message(filters.regex(r"^(?i)AnieXEricaMusic flirt$"))
@error
@save
...
@app.on_message(filters.regex(r"^(?i)AnieXEricaMusic toss$"))
@error
@save
...
@app.on_message(filters.regex(r"^(?i)AnieXEricaMusic decide$"))
@error
@save
