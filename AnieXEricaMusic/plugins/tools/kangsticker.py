...
from AnieXEricaMusic.utils.errors import capture_err

from AnieXEricaMusic.utils.files import (
    get_document_from_file_id,
    resize_file_to_sticker_size,
    upload_document,
)

from AnieXEricaMusic.utils.stickerset import (
    add_sticker_to_set,
    create_sticker,
    create_sticker_set,
...
async def sticker_image(_, message: Message):
    ...
    if not r:
        return await message.reply("Rᴇᴘʟʏ Tᴏ A Sᴛɪᴄᴋᴇʀ Mʏ Dᴜᴍʙ Cᴜᴛɪᴇ ᴘɪᴇ 🤧")
...
async def kang(client, message: Message):
    ...
    msg = await message.reply_text("I Aᴍ Kᴀɴɢɪɴɢ Uɴᴛɪʟ Tʜᴇɴ U Pʟᴢ Dɪᴇ 💀")
    ...
    try:
        if message.reply_to_message.sticker:
            ...
            return await msg.edit("Yᴏᴜ Pʟᴇᴀsᴇ Dɪᴇ Mʏ Kɪɴᴅ Oᴡɴᴇʀ 😭")
